...
function barcodeChangeToZipcode(barcode) {
...
function zipcodeChangeToBarcode(zipcode) {
...
module.exports = {
    ...
    changeToZipcode: changeToZipcode,
    barcodeChangeToZipcode: barcodeChangeToZipcode,
    checkZipcode: checkZipcode,
    chageToBarcode: chageToBarcode,
    zipcodeChangeToBarcode: zipcodeChangeToBarcode,
