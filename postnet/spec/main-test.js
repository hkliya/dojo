...
describe("测邮编的位数（5，9，10正确，4，6，8，11错误）", ()=> {
    it("5位邮编是正确的", ()=> {
        let postcode = '95713';
...
describe(("测'-'的位置(在第六位正确，在第7位，第5位错误)"),()=>{
    it(("在第六位正确"),()=>{
        let postcode = '45056-1234';
        let finalString = finalChangTocodes(postcode);
        const expectText = '|:|::|:|:|:||::::|:|::||:::::||::|:|::||::|::|||:::|';
...
describe(("测条码的位数（32位和52位（不含空格）正确，31位，33位，51位，53位都是错误的）"), ()=> {
    it(("长度为32的条码是正确的"), ()=> {
        let barcode = '||:|:::|:|:|:::|:::||::||::|:|:|';
...
describe(("测条码去掉开始和结尾的|每五位是否合法（含2个|和3个：）"), ()=> {
...
describe(("checkPostcode"), ()=> {
    it(("finalTest1"), ()=> {
        let postcode = '95713';
        let result = checkPostcode(postcode);
        let expectText = true;
